...
This module replaces the former libsodium bindings. It keeps their function
names and returns the same bytes as libsodium. :mod:`crypt4gh.sodium` is a
...
__all__ = ['NONCE_LEN', 'KEY_LEN',
           'chacha20poly1305_encrypt', 'chacha20poly1305_decrypt',
           'derive_pk', 'kx_server', 'kx_client',
           'sign_ed25519_pk_to_curve25519', 'sign_ed25519_sk_to_curve25519']
